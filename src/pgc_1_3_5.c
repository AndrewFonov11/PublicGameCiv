// Public Game Civ version 1.3.5
// Released into the public domain under CC0

#include <stdio.h>
#include <stdlib.h>

int ath = 1,year = 0 - 1500,tp = 0,rnd,tl = 1,res = 10,rpls = 1,ep = 1,defn = 0,alnc = 0,city = 0,win,pr,tc = 0;
char v;
char civ_name[20];
...
void random_()
{
	...
	else if (rnd == 2)
	{
		...
		if (ep == 4) ath -= rand() % 7 + 2;
		if (ep == 5) ath -= rand() % 12 + 3;
		tp--;
		alnc = 0;
		tc = 0;
	}
